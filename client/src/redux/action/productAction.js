...
export const getAdminProduct = () => async (dispatch) => {
  try {
    ...
    const data = await productApi.getAdminProduct();
...
export const newReview = (reviewData) => async (dispatch) => {
  try {
    ...
    const data = await productApi.newReview(reviewData);
...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const data = await productApi.getAllReviews(id);
...
export const deleteReviews = (reviewId, productId) => async (dispatch) => {
  try {
    ...
    const data = await productApi.deleteReviews(reviewId, productId);
